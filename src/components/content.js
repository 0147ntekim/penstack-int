...
const Content = () => {
    return ( 
        <div className='w-full min-h-[90vh] sm:min-h-[100vh]   flex flex-col justify-between px-[25px] py-[110px] sm:py-[30px]'>
            <div className='w-full h-[45vh] sm:h-[65vh] lg:h-[70vh] flex flex-col justify-between'>
